...
export const authAPI = {
  ...
  registerB2B: (data: FormData) => api.post('/auth/register/b2b', data, {
...
export const productAPI = {
  getProducts: (params?: { account_type?: string; category_id?: string; search?: string }) =>
    api.get('/products', { params }),
  getProduct: (productId: string, accountType?: string) =>
    api.get(`/products/${productId}`, { params: { account_type: accountType } }),
}
...
export const adminAPI = {
  ...
  getOrders: (params?: { order_type?: string; order_status?: string; page?: number }) =>
