...
import { registerB2C, registerB2B, login } from '../controllers/auth.controller';
import { upload } from '../utils/fileUpload';

const router = express.Router();

// B2C Registration
router.post('/register/b2c', [
